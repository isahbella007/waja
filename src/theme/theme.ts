...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: "var(--font-heading), Georgia, serif", fontWeight: 700 },
    h2: { fontFamily: "var(--font-heading), Georgia, serif", fontWeight: 700 },
    h3: { fontFamily: "var(--font-heading), Georgia, serif", fontWeight: 600 },
    h4: { fontFamily: "var(--font-heading), Georgia, serif", fontWeight: 600 },
    h5: { fontFamily: "var(--font-heading), Georgia, serif", fontWeight: 600 },
    h6: { fontFamily: "var(--font-heading), Georgia, serif", fontWeight: 600 },
    button: { fontFamily: "var(--font-body), Arial, Helvetica, sans-serif", fontWeight: 600, textTransform: "none" },
